...
The Dashboard Overview page provides a high-level view of the customer base and overall churn situation.

It includes key KPIs and visualizations to understand:
...
![Customer Overview](screenshots/02_customer_overview.png)
...
![Service Subscription Analysis](screenshots/03_service_subscription_analysis.png)
...
## 5. Contract and Billing Insights
...
![Contract and Billing Insights](screenshots/05_contract_and_billing_insights.png)
...
The project contains five Power BI dashboard pages:
...
│   ├── 03_service_subscription_analysis.png
│   ├── 04_churn_analysis.png
│   └── 05_contract_and_billing_insights.png
│
